  ...
  return (
    <>
      ...
      <div className="su-sec">
        <div className="su-sechead"><h2 className="su-sech">Biller commission</h2><span className="su-hint">Paid to the biller out of the practice&apos;s retained share — never a clinician&apos;s payout.</span></div>
        <div className="su-card su-comm">
          ...
          <div className="rate">
            <div>
              ...
              <div className="basis">of insurance collected</div>
            </div>

...
const IcAging = () => S(<><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></>);
    ...
    if (hasBilling) {
      const billing: Item[] = owner
        ? [
            ...
            { href: "/billing/aged-claims", label: "Aged claims", icon: IcAging, match: (p) => p.startsWith("/billing/aged-claims") },

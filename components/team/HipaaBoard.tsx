...
import type { HipaaBoardItem, HipaaStatus, HipaaComment } from "@/lib/hipaa";
...
export default function HipaaBoard({ board, meId, meName }: { board: HipaaBoardItem[]; meId: string; meName: string }) {
